...
import DynamicNotFound from '../components/Error/DynamicNotFound';
        ...
        <div className='relative'>
            ...
            <div className="max-w-6xl mx-auto mt-16 p-8 bg-white shadow-lg rounded-xl flex gap-12 relative">
                ...
                <div className="w-2/3">
                    ...
                    <div className="flex items-center mt-1">
                        {
                            book && Array.from({ length: book.rating }).map((_, index) => ( // static so index is fine
                                <svg className="w-3 h-3 text-yellow-300 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20" key={index}>
                    ...
                    <Link to="/browse" >
                        <button className="mt-8 px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg shadow-md transition cursor-pointer">
                            Back to browse
                        </button>
                    </Link>
                </div>
